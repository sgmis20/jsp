...
<!-- Header -->
	<div class="container  myboard">
		<h3>QNA 수정하기</h3>	
		<form action="<%=request.getContextPath() %>/update2.do?bno=${dto.bno}" method="post" enctype="multipart/form-data" id="modify">
			...
			<div class="form-group">
			  <span class="glyphicon glyphicon-plus">FILE</span>
			  <a href="/upload/${dto.bfile}"><img src="/upload/${dto.bfile}" width="900"/></a>
			</div>
			<div class="form-group">
				<label for="bfile">파일업로드 : </label>
			...
			<div class="form-group  text-right">
					 ...
					 <a href="<%=request.getContextPath() %>/detail2.do?bno=${dto.bno}" class="btn">취소</a>
