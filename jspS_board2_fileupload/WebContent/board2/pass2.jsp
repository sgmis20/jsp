...
<!-- Header -->
	<div class="container  myboard">
		<h3>QNA 비밀번호 확인</h3>
		<form action="<%=request.getContextPath() %>/pass2.do?bno=${param.bno}" method="post"   id="idcheck">
			<input type="hidden" value="${param.bcommand}" id="bcommand"  name="bcommand" />
			...
			<div class="form-group  text-right">
					 ...
					 <a href="<%=request.getContextPath() %>/detail2.do?bno=${param.bno}" class="btn">취소</a>
