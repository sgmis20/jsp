...
import com.company.dao.PagingDAO;
import com.company.dto.Board2;

public class ListPagingCommand implements BCommand4Paging {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		request.setAttribute("onepagelimit", (int)onepagelimit);
		request.setAttribute("pagetotal", (int)pagetotal);
		request.setAttribute("bottomlist", (int)bottomlist);
		request.setAttribute("pstartno", (int)pstartno);
		request.setAttribute("current_page", (int)current_page);
		request.setAttribute("start_page", (int)start_page);
		request.setAttribute("end_page", (int)end_page);
	}
}
