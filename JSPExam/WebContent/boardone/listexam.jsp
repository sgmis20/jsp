...
<%
	...
	String searchWhat = request.getParameter("searchWhat");	//무엇을 검색할지 받아옴(writer, subject, content 현재 3개 중 하나)
	String searchText = request.getParameter("searchText");	//검색할 내용
	
	//파라미터  받아온 값을 한글로 변환
	if(searchText != null) {
		searchText = new String(searchText.getBytes("8859_1"), "euc-kr");
	}
